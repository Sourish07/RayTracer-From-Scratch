...
def render():
    ...
    x0 = -1.7777777777777778
    x1 = 1.7777777777777778
    ...
    silver = Metal(Color(0.3, 0.3, 0.3))
    ...
    objects = [Sphere(Point(-2.5, 0, -2), 0.5, silver),
    ...
    with open("output-sk4.ppm", "w") as f:
        f.write(f"P3\n{WIDTH} {HEIGHT}\n255\n")

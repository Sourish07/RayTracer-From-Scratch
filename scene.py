    ...
    def get_default_scene(self, num):
        ...
        return {
            ...
            5: [
                ...
                Sphere(Point(-0.5, 0, -0.5), 0.5, material_glass),
                Sphere(Point(0.75, 0, -0.5), 0.3, gold),
                Sphere(Point(1, 1, -1), 0.5, material_right)
            ],
            6: [
            ...
            7: [
                Sphere(Point(0, -100.5, -2), 100, material_ground),
                Sphere(Point(-0.5, 0, -1.5), 0.5, material_glass),
                Sphere(Point(0.75, 0, -1.5), 0.3, gold),
                Sphere(Point(1, 3, -2), 0.5, material_right),
            ],
            8: [
                Plane(Point(y=-0.5), Vector(y=1), Diffuse(Color(0.6, 0.5, 0.5))),
                Sphere(Point(1.5, 6, -5), 1, Emissive(intensity=1000)),
